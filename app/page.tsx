  ...
  export default function Home() {
    ...
    return (
      <div className="flex flex-col md:flex-row items-center md:items-start justify-center w-full px-4 md:px-10 py-10 gap-10 bg-gradient-to-br from-slate-500 via-slate-950 to-slate-700 min-h-screen">
    {/* Left Profile Section */}
    <div className="hidden md:block">
      <div>
        <img className="w-[120px] rounded-full" src="/profile.jpg" alt="profile" />
      </div>
    ...
    <div className="flex flex-col items-start text-white text-left max-w-[40rem] w-full">
      ...
      <div className="text-start w-full">
        ...
        <div className="text-start py-10">
          My Strength is building core web applications which solve problems and scalable. I'm currently working with full Stack Development. feel free for contacting me for any work or project.
        </div>
        ...
        <div>
          ...
          <div className="flex flex-col gap-5">
            <div className="flex items-center gap-10">
              <span><Github /></span>
              <span><a className="hover:underline" href="https://github.com/TheManishDaksh" target="_blank" rel="noopener noreferrer">@TheManishDaksh</a></span>
            </div>
            <div className="flex items-center gap-8">
              <span><Twitter /></span>
              <span><a className="hover:underline" href="https://x.com/manish_dakshh" target="_blank" rel="noopener noreferrer">@manish_dakshh</a></span>
            </div>
            <div className="flex items-center gap-14">
              <span><Mail /></span>
              <span><p className="hover:underline">manishk78625@gmail.com</p></span>
            </div>
          </div>
        </div>
      </div>
